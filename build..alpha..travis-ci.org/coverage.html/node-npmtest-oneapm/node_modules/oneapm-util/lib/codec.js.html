...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-oneapm/node_modules/oneapm-util/lib/codec.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-oneapm/node_modules/oneapm-util/lib/codec.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-oneapm/node_modules/oneapm-util/lib/</a> &#187; codec.js</div>
</div>
<div class="body">
...
module.exports = {
   ...
   *                            object.
   */
  encode : <span class="fstat-no" title="function not covered" >function encode(data, callback) {</span>
<span class="cstat-no" title="statement not covered" >    zlib.deflate(JSON.stringify(data), <span class="fstat-no" title="function not covered" >function cb_deflate(err, raw) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return callback(null, raw.toString('base64'));</span>
    });
  },
&nbsp;
  /**
   ...
   *                            decoded data object.
   */
  decode : <span class="fstat-no" title="function not covered" >function decode(encoded, callback) {</span>
<span class="cstat-no" title="statement not covered" >    zlib.inflate(new Buffer(encoded, 'base64'), <span class="fstat-no" title="function not covered" >function cb_inflate(err, raw) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (err) <span class="cstat-no" title="statement not covered" >return callback(err);</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        return callback(null, JSON.parse(raw));</span>
      }
      catch (error) {
