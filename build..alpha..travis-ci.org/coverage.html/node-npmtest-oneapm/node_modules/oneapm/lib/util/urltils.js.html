...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-oneapm/node_modules/oneapm/lib/util/urltils.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-oneapm/node_modules/oneapm/lib/util/urltils.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-oneapm/node_modules/oneapm/lib/util/</a> &#187; urltils.js</div>
</div>
<div class="body">
...
module.exports = {
   ...
   */
  isError : <span class="fstat-no" title="function not covered" >function isError(config, code) {</span>
...
<span class="cstat-no" title="statement not covered" >      codes = config.error_collector.ignore_status_codes;</span>
    }
<span class="cstat-no" title="statement not covered" >    return code &gt;= 400 &amp;&amp; codes.indexOf(code) === -1;</span>
  },
&nbsp;
  /**
   ...
   */
  scrub : <span class="fstat-no" title="function not covered" >function scrub(requestURL) {</span>
<span class="cstat-no" title="statement not covered" >    var path = url.parse(requestURL).pathname;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (path) {</span>
<span class="cstat-no" title="statement not covered" >      path = path.split(';')[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (path !== '/' &amp;&amp; path.charAt(path.length - 1) === '/') {</span>
...
&nbsp;
   ...
   */
  parseParameters : <span class="fstat-no" title="function not covered" >function parseParameters(requestURL) {</span>
<span class="cstat-no" title="statement not covered" >    var parsed     = url.parse(requestURL, true)</span>
      , parameters = {}
      ;
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (parsed.search !== '') {</span>
<span class="cstat-no" title="statement not covered" >      Object.keys(parsed.query).forEach(<span class="fstat-no" title="function not covered" >function cb_forEach(key) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (parsed.query[key] === '' &amp;&amp; parsed.path.indexOf(key + '=') &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >          parameters[key] = true;</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >          parameters[key] = parsed.query[key];</span>
        }
      });
    }
&nbsp;
...
&nbsp;
   ...
   *                             (mutated in place).
   */
  copyParameters : <span class="fstat-no" title="function not covered" >function copyParameters(config, source, destination) {</span>
<span class="cstat-no" title="statement not covered" >    if (!(config &amp;&amp; config.capture_params &amp;&amp; source &amp;&amp; destination)) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      if (config.ignored_params.indexOf(key) === -1 &amp;&amp; !(key in destination)) {</span>
